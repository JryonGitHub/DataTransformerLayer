...
void DataTransformerLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
  ...
  */
  caffe_rng_gaussian(this->_colordistortion_delta1.count(), (Dtype)0, this->_colordistortion_delta1_sigma, this->_colordistortion_delta1.mutable_cpu_data());
  caffe_rng_gaussian(this->_colordistortion_delta2.count(), (Dtype)0, this->_colordistortion_delta2_sigma, this->_colordistortion_delta2.mutable_cpu_data());
  caffe_rng_gaussian(this->_colordistortion_delta3.count(), (Dtype)0, this->_colordistortion_delta3_sigma, this->_colordistortion_delta3.mutable_cpu_data());
  caffe_rng_gaussian(this->_colordistortion_delta4.count(), (Dtype)0, this->_colordistortion_delta4_sigma, this->_colordistortion_delta4.mutable_cpu_data());
